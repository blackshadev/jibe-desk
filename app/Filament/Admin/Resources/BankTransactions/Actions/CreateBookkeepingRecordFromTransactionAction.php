...
final class CreateBookkeepingRecordFromTransactionAction
{
    public static function make(): Action
    {
        return Action::make('createBookkeepingRecordFromTransaction')
            ...
            ->schema(static function (RelationManager $livewire, BankTransaction|BankStatement|null $record): array {
            ...
            ->action(static function (array $data, RelationManager $livewire, BankTransaction|BankStatement|null $record, BankTransactionRepository $repository): void {
                $record = GetTransaction::get($livewire, $record);
